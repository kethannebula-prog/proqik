...
<nav class="nav" id="nav">
  ...
  <div class="nav-links">
    ...
    <span class="nav-a" onclick="smoothTo('app-download')">Get the App</span>
  </div>
  <div class="nav-end">
    <button class="btn-ghost" onclick="window.location.href='<%= request.getContextPath() %>/login'">Sign In</button>
    <button class="btn-primary" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Get Started Free</button>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-left">
    ...
    <div class="search-box">
      ...
      <button class="search-go" onclick="window.location.href='<%= request.getContextPath() %>/signup'">
    ...
    <div class="trending">
      ...
      <span class="tr-tag" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Portrait sessions</span>
      <span class="tr-tag" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Corporate events</span>
      <span class="tr-tag" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Aerial drone</span>
      <span class="tr-tag" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Album design</span>
      <span class="tr-tag" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Fashion shoots</span>
    </div>
  </div>
...
<section class="svc-sec" id="services">
  <div class="wrap">
    <div class="sec-row">
      ...
      <button class="btn-cta reveal d3" onclick="window.location.href='<%= request.getContextPath() %>/signup'">Join for free →</button>
    </div>
    <div class="svc-grid">
      <div class="svc-card reveal d1" onclick="window.location.href='<%= request.getContextPath() %>/signup'">
      ...
      <div class="svc-card reveal d2" onclick="window.location.href='<%= request.getContextPath() %>/signup'">
      ...
      <div class="svc-card reveal d3" onclick="window.location.href='<%= request.getContextPath() %>/signup'">
...
<!-- APP DOWNLOAD -->
<section class="app-sec" id="app-download">
  <div class="wrap">
    <div class="app-inner">
      <div>
