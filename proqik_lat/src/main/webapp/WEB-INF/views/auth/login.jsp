...
if (loginError != null && errorMsg == null) {
    if ("pending".equals(loginError)) {
        errorMsg = "Your application is pending admin approval. Please wait for confirmation.";
    } else if ("rejected".equals(loginError)) {
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="login-error<%= errorMsg != null ? " show" : "" %>">
            ...
            <a href="<%= request.getAttribute("googleAuthUrl") != null ? request.getAttribute("googleAuthUrl") : "#" %>" class="google-btn" style="text-decoration:none;display:flex;align-items:center;justify-content:center;gap:12px;">
